...
__Примечание:__
В реализации библиотеки умышленно сделано две ошибки (оттого CI не проходит):  
- Ошибка линковки. 
...
## Quick Start
Корректная реализация библиотеки лежит в program_options_lib.zip (потребует от вас введения пароля)  
Распаковка 
~~~
unzip program_options_lib.zip -d ./program_options_lib_correct && rm -rf program_options_lib.zip
~~~
